...
if ( ! function_exists( 'wordpress_demo_setup' ) ) :
/**
...
function wordpress_demo_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wordpress-demo' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'wordpress_demo_custom_background_args', array(
...
function wordpress_demo_scripts() {
	wp_enqueue_style( 'wordpress-demo-style', get_stylesheet_uri() );

	wp_enqueue_script( 'wordpress-demo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wordpress-demo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
