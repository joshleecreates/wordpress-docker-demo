...
define('WPMS_SET_RETURN_PATH', getenv('WPMS_SET_RETURN_PATH')); // Sets $phpmailer->Sender if true
define('WPMS_SMTP_HOST', getenv('WPMS_SMTP_HOST')); // The SMTP mail host
define('WPMS_SMTP_PORT', getenv('WPMS_SMTP_PORT')); // The SMTP server port number
define('WPMS_SSL', getenv('WPMS_SSL')); // Possible values '', 'ssl', 'tls' - note TLS is not STARTTLS
define('WPMS_SMTP_AUTH', true); // True turns on SMTP authentication, false turns it off
define('WPMS_SMTP_USER', getenv('WPMS_SMTP_USER')); // SMTP authentication username, only used if WPMS_SMTP_AUTH is true
define('WPMS_SMTP_PASS', getenv('WPMS_SMTP_PASS')); // SMTP authentication password, only used if WPMS_SMTP_AUTH is true
